...
import com.rollingstone.prescriptioncheckout.exceptions.RestAPIExceptionInfo;
...
public abstract class AbstractController implements ApplicationEventPublisherAware {
                                                                        ...
                                                                        WebRequest request, HttpServletResponse response)
    {
        ...
        return new RestAPIExceptionInfo(new Date(), ex.getLocalizedMessage(), "The Request did not have the correct paramaters");
    }
                                                                              ...
                                                                              WebRequest request, HttpServletResponse response)
    {
        ...
        return new RestAPIExceptionInfo(new Date(), ex.getLocalizedMessage(), "The Requested Resource was not found");
    }
